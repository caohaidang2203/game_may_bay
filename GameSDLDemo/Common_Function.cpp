...
int SDLCommonFunc::ShowMenu(SDL_Surface* des, TTF_Font* font){
	g_img_menu = LoadImage("bk_menu.jpg");
	if(g_img_menu == NULL){
		return 1;
	}
...
// ham LoadImage thuc hien load cac image
SDL_Surface* SDLCommonFunc::LoadImage(std::string file_path)
{
  SDL_Surface * load_image = NULL;
  SDL_Surface* optimize_image = NULL;//toi uu hoa dinh dang tam anh
...
//Ham AppySurface thuc hien viec load surface nguon vao 1 cai surface dich
...
// ham giai phong cac doi tuong bien global
